...
const envSchema = z.object({
  ...
  OPENCODE_ZEN_API_KEY: z.string().optional().default("free_tier_active"),
  OPENCODE_ZEN_BASE_URL: z.string().url().default("https://api.opencodezen.com/v1"),
  OPENCODE_DEFAULT_REASONING_MODEL: z.string().default("opencode/nemotron-3-ultra:free"),
  OPENCODE_FAST_MODEL: z.string().default("opencode/nemotron-3.5-lightning:free"),
  OPENCODE_LONG_CONTEXT_MODEL: z.string().default("opencode/ling-3.0-flash-fin:free"),
  OPENCODE_STRUCTURED_MODEL: z.string().default("opencode/mimo-v2.5:free"),
  OPENCODE_CREATIVE_MODEL: z.string().default("opencode/muse-spark-1.3:free"),
...
export const env = envSchema.parse({
  ...
  OPENCODE_DEFAULT_REASONING_MODEL: process.env.OPENCODE_DEFAULT_REASONING_MODEL,
  OPENCODE_FAST_MODEL: process.env.OPENCODE_FAST_MODEL,
  OPENCODE_LONG_CONTEXT_MODEL: process.env.OPENCODE_LONG_CONTEXT_MODEL,
  OPENCODE_STRUCTURED_MODEL: process.env.OPENCODE_STRUCTURED_MODEL,
  OPENCODE_CREATIVE_MODEL: process.env.OPENCODE_CREATIVE_MODEL,
