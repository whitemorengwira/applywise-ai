...
export const OPENCODE_MODELS: ModelOption[] = [
  ...
  },
  {
    ...
    role: "Architecture Blueprint Generation",
    badge: "Image",
    icon: ImageIcon,
    color: "text-sky-400",
  ...
  },
  {
    ...
    role: "Audio Speech-to-Text & Transcription",
    badge: "Audio",
    icon: Mic,
    color: "text-teal-400",
  ...
  },
  {
    ...
    shortName: "Kokoro 82M TTS",
    role: "Notification Voice Reader Speech Synthesis",
    badge: "Voice",
    icon: Mic,
  ...
  },
  {
    ...
    shortName: "Wan 2.1 Video",
    role: "Architecture Walkthrough Demonstration Video",
    badge: "Video",
    icon: VideoIcon,
    color: "text-rose-400",
