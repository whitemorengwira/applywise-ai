          ...
          <Card className="border-border/80 bg-card/70 p-5 space-y-4">
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30 border border-border/50">
                ...
                <div className="space-y-1">
                  <h5 className="text-xs font-semibold text-foreground">Dynamic Model Router</h5>
                  <p className="text-[11px] text-foreground-muted leading-relaxed">
                    Routes high-reasoning RAG to Gemini 2.0 Flash Thinking and fast structured extraction to Llama 3.3.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30 border border-border/50">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-foreground-muted leading-relaxed">
                    Cosine distance embeddings over career achievements prevent generic hallucinations during CV generation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30 border border-border/50">
                ...
                <div className="space-y-1">
                  <h5 className="text-xs font-semibold text-foreground">Multi-Stage ATS Evaluation</h5>
                  <p className="text-[11px] text-foreground-muted leading-relaxed">
                    Deterministic scoring rubrics assess technical proficiency, domain alignment, and experience level.
                  </p>
                </div>
              </div>
            </div>
